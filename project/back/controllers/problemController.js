...
const addProblemController = async (req, res) => {
    ...
    try {
        const problem = await addProblem(title, description, difficulty, created_by);
...
const updateProblemController = async (req, res) => {
    ...
    try {
        const updatedProblem = await updateProblem(problem_id, title, description, difficulty);
